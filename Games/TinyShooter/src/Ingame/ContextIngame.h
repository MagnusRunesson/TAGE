...
#define SPRITE_COLLISION_INDEX_UNIMPORTANT	(1)
#define SPRITE_COLLISION_INDEX_PLAYERSHIP	(2)
#define SPRITE_COLLISION_INDEX_PLAYERBULLET	(3)
#define SPRITE_COLLISION_INDEX_ENEMY		(4)
#define SPRITE_COLLISION_INDEX_PICKUP		(5)
#define SPRITE_COLLISION_INDEX_ENEMYBULLET	(6)
